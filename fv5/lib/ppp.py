...
<head>
  ...
  <!-- The site pair, light and dark. These private pages were the only pages
       left painting the browser chrome brown: scripts/build_site.py rewrites
       this tag on every public page as it builds, and it never sees these, so
       the buyer's tab did not match the shop it was bought from. -->
  <meta name="theme-color" media="(prefers-color-scheme: light)" content="#f9fafb">
  <meta name="theme-color" media="(prefers-color-scheme: dark)" content="#0d0f13">
