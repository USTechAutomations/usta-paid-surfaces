#!/usr/bin/env python3
"""Deliver a pro key for casepack after a paid checkout. No email anywhere.
...
Run:  python3 fv5/families/casepack/fulfil.py --fixture \
        fv5/families/casepack/fixtures/session_paid.json
"""
...
FAMILY = "casepack"
LINK_ID_ENV_OR_CATALOG = "casepack"
PRODUCT_NAME = "Wholesale reorder sheet — pro key"
ETA_MINUTES = 10
PLAN = "monthly"
...
PASTE_WHERE = (
    "Paste this key into the \"Pro key\" box on the builder form when you "
    "create or edit your reorder sheet."
)
