#!/usr/bin/env python3
"""Deliver a pro key for qrelay after a paid checkout. No email anywhere.
...
Run:  python3 fv5/families/qrelay/fulfil.py --fixture \
        fv5/families/qrelay/fixtures/session_paid.json
"""
...
FAMILY = "qrelay"
LINK_ID_ENV_OR_CATALOG = "qrelay"
PRODUCT_NAME = "Security questionnaire relay — pro key"
ETA_MINUTES = 10
PLAN = "monthly"
...
PASTE_WHERE = (
    "Paste this key into the key box when you send a questionnaire from the "
    "qrelay page (the same box the /q/new form shows)."
)
