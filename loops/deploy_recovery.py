...
MONTHLY_FILES = ["loops/service/subscription_access.py", "loops/service/apps/__init__.py",
                 "loops/service/apps/qrelay.py", "loops/service/apps/ledgermatch.py"]
...
def main():
    ...
    if args.expected_image and image != args.expected_image:
        raise RuntimeError("The serving image changed; reconcile all scoped files before publishing")
