...
| boston | Boston building permits in one file | GCs, lenders, data teams needing Boston approved permits without applicant names | $349 once per slice | LIVE buy.stripe.com button, $349 one-time (minted 25 Aug 2026) | sample.csv in the family folder | **Live 25 Aug 2026**. Analyze Boston PDDL. applicant+comments stripped. |
| nyc-ll84 | NYC LL84 energy-and-water disclosure files | LL97 / energy-compliance teams, not permit GCs | $349 once per year or borough slice | LIVE buy.stripe.com button, $349 one-time (minted 25 Aug 2026) | 25-row sample in the family folder | **Live 25 Aug 2026**. View 5zyy-y8am. Monthly kBtu SKU not minted. Not permit-files/new-york. |
| washington-dc | Washington DC building-permit files | DC GCs, expediters, lenders | $349 once per slice (4 years + concatenation) | none until minted; assembled CSV via `scripts/assemble_city_file.py --city washington-dc --slice <s>` | 25-row sample in the family folder | **Merged 25 Aug 2026** from task-m5-dc-rework. CC BY 4.0 — credit line + licence line are required_text and ride every file. Person columns + DESC_OF_WORK stripped. Layers 15-18 only. |
