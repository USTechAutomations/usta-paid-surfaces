...
| boston | Boston building permits in one file | GCs, lenders, data teams needing Boston approved permits without applicant names | $349 once per slice | none until minted; assembled CSV via email | sample.csv in the family folder | **Proposed 26 Aug 2026**. Analyze Boston PDDL. applicant+comments stripped. |
| nyc-ll84 | NYC LL84 energy-and-water disclosure files | LL97 / energy-compliance teams, not permit GCs | $349 once per year or borough slice | none; one-time CSV via email | 25-row sample in the family folder | **Proposed 26 Aug 2026**. View 5zyy-y8am. Checkout empty. Monthly kBtu SKU not minted. Not permit-files/new-york. |
