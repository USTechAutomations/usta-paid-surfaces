...
def ttb(sample_json: dict | None = None) -> dict:
    ...
    return {
        ...
        "h1": "TTB permittees: who appeared and who stopped being listed",
        "buyer": "Beverage compliance and wholesaler ops",
        "desc": f"TTB permittees: named US alcohol permits that appeared or stopped being listed between {frm} and {to}. {j['appeared_count']} appeared, {j['gone_count']} gone. {p}.",
